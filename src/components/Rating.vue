<template>
  <div class="card">
    <div v-if="mode != 'response'" class="base">
      <div class="star">
    ...
    <div v-if="mode == 'response'" class="response">
      ...
      <p class="p center">You selected {{ number }} out of 5</p>
      <h2 class="center">Thank you!</h2>
      <p class="center">We appreciate you taking the time to give a rating.</p>
      <p class="center">If you ever need more support, don’t hesitate to get in touch!</p>
    </div>
  </div>
</template>
